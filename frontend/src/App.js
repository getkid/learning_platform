...
import CourseListPage from './pages/CourseListPage'; // <-- 1. Импортируем

const HomePage = () => <h1>Home Page</h1>;
const ProfilePage = () => <h1>User Profile Page</h1>;
// Заглушка для будущей страницы конкретного курса
const CourseDetailPage = () => <h1>Course Detail Page</h1>; 
